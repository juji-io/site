...
Unfortunately, there is a chasm between using LLMs for personal productivity
...
creating a chatbot solution with GPT-4, it can easily [take months and cost
millions of
dollars](https://juji.io/blog/can-i-build-my-chatbot-with-gpt-4-how-hard-is-it/),
not to mention the required deep AI expertise and engineering skills.
