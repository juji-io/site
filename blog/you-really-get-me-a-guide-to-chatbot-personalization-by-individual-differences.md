...
All the examples above show that a chatbot would be able to offer personalized suggestions and advices if it knows the ***[individual differences](https://en.wikipedia.org/wiki/Personality_and_Individual_Differences)***--the unique characteristics--of its users. Broadly speaking, individual differences are a set of characteristics that define a person as a unique individual, also known as one's ***personality***. One's personality describes a person from three broad aspects. First, it describes what a person likes to do, including the person's passions and interests. Second, it describes what a person is good at, such as the person's talents and skills. Third, it describes how a person deals with life's challenges, such as handling emotional and social challenges. 
